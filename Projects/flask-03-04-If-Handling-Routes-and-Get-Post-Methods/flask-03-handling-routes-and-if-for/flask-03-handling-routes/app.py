...
@app.route("/about")
def about():
    return "<h1>Dis is abutt page</h1>"
...
# do same as above with html page instead of inline
@app.route('/<name>')
def greet(name):
...
#can list variable here like     return render_template('list10.html', interval = range(1,11))
...
#again can send interval from app
